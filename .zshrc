...
export FZF_DEFAULT_OPTS='
  --color=bg+:#333333,bg:#121212,fg:#e8e0c8,fg+:#e8e0c8
  --color=hl:#f0c040,hl+:#f0c040
  --color=info:#d4a017,prompt:#f0c040,pointer:#f0c040
  --color=marker:#ffbf00,spinner:#d4a017,header:#999999
  --color=border:#555555,label:#d4a017,query:#e8e0c8
  --color=gutter:#121212,separator:#3a3a3a,scrollbar:#555555
'
